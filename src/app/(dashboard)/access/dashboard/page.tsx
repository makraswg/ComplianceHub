...
export default function AccessHubDashboard() {
  ...
  const stats = useMemo(() => {
    ...
    return {
      ...
      activeAss: activeAssignments.length,
      admins,
      driftCount,
      reviewPercent
    };
        ...
        <Card className="rounded-2xl border-none shadow-xl bg-slate-900 text-white overflow-hidden relative group">
            ...
            <CardContent className="p-8 space-y-6 relative z-10">
                ...
                <div className="space-y-1">
                    <h3 className="text-3xl font-headline font-black tracking-tight">{stats.reviewPercent}%</h3>
                ...
                <div className="space-y-3 pt-2">
                    ...
                    <Progress value={stats.reviewPercent} className="h-1.5 bg-white/10" />
                    <p className="text-[9px] text-slate-400 leading-relaxed italic mt-4">
                        Zeigt den Anteil der aktiven Berechtigungen, die im laufenden Review-Zyklus bereits bestätigt wurden.
                    </p>
                </div>
            </CardContent>
        </Card>
        ...
        <div className="lg:col-span-2 grid grid-cols-1 sm:grid-cols-2 gap-4">
            <Card className="rounded-2xl border shadow-sm bg-white dark:bg-slate-900 overflow-hidden group hover:border-primary/20 transition-all">
                <CardContent className="p-6 flex items-center justify-between">
                    <div className="space-y-1">
                        <p className="text-[10px] font-black uppercase text-slate-400 tracking-widest">Gepflegte Identitäten</p>
                        ...
                        <div className="flex items-center gap-1.5 text-[9px] text-emerald-600 font-bold uppercase mt-1">
                            <Activity className="w-3 h-3" /> System Synchron
                        </div>
                    </div>
            ...
            <Card className="rounded-2xl border shadow-sm bg-white dark:bg-slate-900 overflow-hidden group hover:border-red-200 transition-all">
                <CardContent className="p-6 flex items-center justify-between">
                    <div className="space-y-1">
                        <p className="text-[10px] font-black uppercase text-slate-400 tracking-widest">Privilegierte Konten</p>
                        <h3 className="text-2xl font-black text-red-600">{stats.admins}</h3>
                        <p className="text-[9px] text-slate-500 font-medium italic">Kritische Admin-Rechte</p>
                    </div>
                ...
                <CardContent className="p-6 flex items-center justify-between">
                    <div className="flex items-center gap-4">
                        ...
                        <div className="space-y-0.5">
                            ...
                            <h3 className="text-sm font-bold text-slate-800 dark:text-slate-100">{stats.driftCount} Identitäten mit Drift</h3>
                            <p className="text-[9px] text-slate-500">Abweichungen zwischen Hub und Netzwerk erkannt.</p>
                        </div>
                    </div>
                ...
                <CardContent className="p-6 flex items-center justify-between">
                    <div className="flex items-center gap-4">
                        ...
                        <div className="space-y-0.5">
                            ...
                            <h3 className="text-sm font-bold text-slate-800 dark:text-slate-100">Ready for Sync</h3>
                            <p className="text-[9px] text-slate-500">Tickets in der Warteschlange verfügbar.</p>
                        </div>
                    </div>
        ...
        <Card className="xl:col-span-2 border shadow-sm bg-white dark:bg-slate-900 rounded-2xl overflow-hidden">
          <CardHeader className="p-6 border-b bg-slate-50/50 flex flex-row items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <CardTitle className="text-sm font-bold">Intelligente Handlungsempfehlungen</CardTitle>
                <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">Identifizierte Quick-Wins & Governance Aufgaben</p>
              </div>
            </div>
              ...
              <div className="flex items-center justify-between p-4 bg-amber-50 border border-amber-100 rounded-2xl group hover:shadow-md transition-all cursor-pointer" onClick={() => router.push('/users?status=drift')}>
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-[10px] text-amber-700 leading-relaxed font-medium">{stats.driftCount} Identitäten weichen von den Blueprints ab. Starten Sie einen Sync-Run.</p>
                  </div>
                </div>
            ...
            <div className="flex items-center justify-between p-4 bg-indigo-50 border border-indigo-100 rounded-2xl group hover:shadow-md transition-all cursor-pointer" onClick={() => router.push('/lifecycle')}>
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-[10px] text-indigo-700 leading-relaxed font-medium">Neue Mitarbeiter im Vorlauf? Erstellen Sie Onboarding-Pakete für schnelleren Zugriff.</p>
                </div>
              </div>
              <ArrowRight className="w-4 h-4 text-indigo-400 group-hover:translate-x-1 transition-transform" />
            </div>

            <div className="flex items-center justify-between p-4 bg-emerald-50 border border-emerald-100 rounded-2xl group hover:shadow-md transition-all cursor-pointer" onClick={() => router.push('/iam-audit')}>
              <div className="flex items-center gap-4">
                <div className="w-10 h-10 rounded-xl bg-white flex items-center justify-center text-emerald-600 shadow-sm border border-emerald-100"><BrainCircuit className="w-5 h-5" /></div>
                <div>
                  <h4 className="text-sm font-bold text-emerald-900">Deep IAM Audit</h4>
                  <p className="text-[10px] text-emerald-700 leading-relaxed font-medium">Lassen Sie die KI nach Segregation of Duties (SoD) Konflikten in Ihren Rollen suchen.</p>
                </div>
              </div>
